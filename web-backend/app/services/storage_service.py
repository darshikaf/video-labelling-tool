...
class StorageService:
    ...
    def get_mask_data(self, object_key: str) -> bytes:
        """
        Get the actual mask data from object storage
        ...
        try:
            ...
            print(f"Error retrieving mask data: {e}")
            raise
    ...
    def store_frame_image(
        self, project_id: int, video_id: int, frame_number: int, image_data: bytes
    ) -> str:
        """
    ...
    def store_annotation(
        ...
        try:
            ...
            extensions = {"YOLO": ".txt", "COCO": ".json", "PASCAL_VOC": ".xml"}
    ...
    def store_mask_and_annotation(
        ...
        try:
            # Store mask
            mask_key = self.store_mask(
                project_id, video_id, frame_number, annotation_id, mask_data
            )

            # Store annotation
            annotation_key = self.store_annotation(
                project_id,
                video_id,
                frame_number,
                annotation_id,
